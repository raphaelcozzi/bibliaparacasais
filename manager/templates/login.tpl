...
<html lang="en">
    ...
    <head>
        ...
        <link href="{ABS_LINK}assets/pages/css/login.min.css" rel="stylesheet" type="text/css" />
    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="#">
                <img src="{ABS_LINK}assets/pages/img/logo-big.png" alt="" /> </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="index.php?module=login&method=logar" method="post" name="forms_cad">
                <h3 class="form-title font-green">ACESSO RESTRITO</h3>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="Email" name="login" /> </div>
                <div class="form-group">
            ...
            <select id="cidades" name="cidade" class="form-control" >
                ...
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">Digite sua senha novamente</label>
                    <input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Digite sua senha novamente" name="senha2" /> </div>
        ...
        <div class="copyright"> 2010 - 2019 © {TITULO_SISTEMA}. </div>
        <!--[if lt IE 9]>
...
{ANALYTICS}
        ...
        <!-- BEGIN CORE PLUGINS -->
          <script src="{ABS_LINK}assets/global/plugins/jquery-1.4.2.min.js" type="text/javascript"></script>
        ...
        <script src="{ABS_LINK}assets/pages/scripts/login.min.js" type="text/javascript"></script>
...
<html lang="en">
    ...
    <body class=" login">
        ...
        <script src="{ABS_LINK}assets/global/plugins/jquery-slimscroll/jquery.slimscroll.min.js" type="text/javascript"></script>
        <script src="{ABS_LINK}assets/global/plugins/jquery.blockui.min.js" type="text/javascript"></script>
        <script src="a{ABS_LINK}ssets/global/plugins/bootstrap-switch/js/bootstrap-switch.min.js" type="text/javascript"></script>
        <!-- END CORE PLUGINS -->
        <!-- BEGIN PAGE LEVEL PLUGINS -->
        <script src="{ABS_LINK}assets/global/plugins/jquery-validation/js/jquery.validate.min.js" type="text/javascript"></script>
        <script src="{ABS_LINK}assets/global/plugins/jquery-validation/js/additional-methods.min.js" type="text/javascript"></script>
