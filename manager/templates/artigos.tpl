                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <!-- BEGIN EXAMPLE TABLE PORTLET-->
                             <div>
                                    <a href="artigos/novo" class="btn default green-stripe">
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">Listagem de Artigos</span>
                                    </div>
...
#uploadavatar{
    display:none;
                                            ...
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    <i class="fa fa-edit"></i>Publicar novo Artigo</div>
                                            </div>
                                            <div class="portlet-body form">
                                                <!-- BEGIN FORM-->
                                                <form action="index.php?module=artigos&method=insereArtigo" method="post" name="editar" id="formartigo"  class="form-horizontal" enctype="multipart/form-data">
                                                    <div class="form-body">
...
<script>
  ...
  var quill = new Quill('#edit', {
    ...
    placeholder: 'Escreva aqui o conteudo do seu artigo...',
    theme: 'snow'
  });
...
<!-- BEGIN categorias -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <!-- BEGIN EXAMPLE TABLE PORTLET-->
                             <div>
                                    <a href="artigos/novoCategoria" class="btn default green-stripe">
                                            <i class="fa fa-plus"></i> Incluir </a>
                              </div>
                              <br>
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        <i class="icon-list font-dark"></i>
                                        <span class="caption-subject bold uppercase">Categorias de Artigos</span>
                                    </div>
...
#uploadavatar{
    display:none;
                                        ...
                                        <div class="portlet light bordered">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    <i class="fa fa-user"></i>Nova Categoria de Artigo </div>
                                            </div>
                                            <div class="portlet-body form">
                                                <!-- BEGIN FORM-->
                                                <form action="index.php?module=artigos&method=insereCategoria" method="post" name="editar"  class="form-horizontal" enctype="multipart/form-data">
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                           <label class="col-md-3 control-label">T&iacute;tulo</label>
                                                            <div class="col-md-4">
                                                       ...
                                                       <div class="form-group">
                                                           <label class="col-md-3 control-label">Imagem de Destaque</label>
                                                            <div class="col-md-4">
                                                <a href="javascript:void(0);" id="upload_link2">
                                                   <img src="http://www.placehold.it/200x200/EFEFEF/AAAAAA&amp;text=NENHUMA" alt="" id="theavatar" class="avatar img-square img-responsive" width="100%">
                                              </a>
...
#uploadavatar{
    display:none;
                                        ...
                                        <div class="portlet light bordered">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                   <i class="fa fa-user"></i>Editar Categoria de Artigo</div>
                                            </div>
                                            <div class="portlet-body form">
                                                <!-- BEGIN FORM-->
                                                <form action="index.php?module=artigos&method=updateCategoria" method="post" name="editar"  class="form-horizontal" enctype="multipart/form-data">
...
#uploadavatar{
    display:none;
                                            ...
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    <i class="fa fa-list"></i>Editando o Artigo: <strong>{titulo}</strong> </div>
                                            </div>
                                            <div class="portlet-body form">
                                                <!-- BEGIN FORM-->
                                                <form action="index.php?module=artigos&method=updateArtigo" method="post" name="editar" id="formartigo"  class="form-horizontal" enctype="multipart/form-data">
                                                   <input type="hidden" name="artigo_id" value="{artigo_id}">
                                                    <div class="form-body">
                                                       
                                                        <div class="form-group">
                                                           <label class="col-md-3 control-label">Publicado por:</label>
                                                            <div class="col-md-4">
                                                               <h3 style="margin-top:0px;"><a href="usuarios/edita/{autor}" target="_blank">{nome_usuario}</a></h3>
                                                                <span class="help-block"> Autor do artigo. </span>
                                                            </div>
                                                        </div>
                        ...
                        <div class="col-md-12">
                            <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                ...
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        <i class="icon-list font-dark"></i>
                                        <span class="caption-subject bold uppercase">Coment&aacute;rios feitos no artigo</span>
                                    </div>
