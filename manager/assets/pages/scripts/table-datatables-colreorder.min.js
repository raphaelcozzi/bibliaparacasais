...
var TableDatatablesColreorder = function() {
    var e = function() {
            ...
            e.dataTable({
                ...
                buttons: [{
                    extend: "print",
                    className: "btn dark fa fa-print"
                }, {
                    extend: "pdf",
                    className: "btn red fa fa-file-pdf-o"
                }, {
                    extend: "csv",
                    className: "btn blue fa fa-file-excel-o "
                }],
                responsive: !0,
                colReorder: {
