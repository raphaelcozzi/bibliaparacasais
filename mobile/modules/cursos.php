      ...
      if(!isset($_SESSION['id']))
      {
         ...
         if(strpos($video, "youtube") || strpos($video, "youtu"))
         {
               if($video != "" && strlen($video) > 5)
               {
                  ...
                  $conteudo .= '</span></p><a href="#" data-menu="menu-video"><img src="images/play.png" style="width:100%; margin-top:10px; position:absolute; z-index:9999999;"><img src="https://img.youtube.com/vi/'.$videoid.'/0.jpg" width="100%"></a>';
               }
