		...
		for($i = 0; $i < $db->num_rows(); $i++)
		{
         $velho_testamento .= '<div class="list-group-item">
                                        <div class="row-content">
                                            <p class="list-group-item-heading"><a href="'.ABS_LINK.'acf/'.$db->f("liv_abreviado").'"><i class="material-icons">description</i> 
                                           '.$db->f("liv_nome").'</a></p>
                                        </div>
                                    </div>';
    ...
    function livro($sigla = "acf")
   {
      ...
      if(!isset($_REQUEST['subid'])) // Mostra a view do livro
      {
         ...
         for($i = 0; $i < $db->num_rows(); $i++)
         {
            ...
            if($itens_linha == 0)
            {
               ...
               $listagem_capitulos .= '<div style="width:10%; float:left;">
                  <a href="'.ABS_LINK.$sigla.'/'.$liv_abreviado.'/'.$ver_capitulo.'" style="font-size:25px;">'.$ver_capitulo.'</a>
               </div>';
         ...
         for($i = 0; $i < $db->num_rows(); $i++)
         {
           ...
           $listagem_ultimas_respostas .= '<li><a href="'.ABS_LINK.$sigla.'/'.$liv_abreviado.'#'.$db->f("id").'">'.$db->f("resposta").'...</a></li>';
         ...
         $comentarios_recentes .= '<div class="list-group-item">
                                            <div class="row-topic">
                                                <header class="topic-title clearfix">
                                                    <h3><a href="'.ABS_LINK.$sigla.'/'.$liv_abreviado.'">'.$db->f("resposta").'...</a></h3>
      ...
      else // Mostra a view dos versículos do capítulo escolhido
      {
         ...
         for($i = 0; $i < $db->num_rows(); $i++)
         {
           ...
           $listagem_ultimas_respostas .= '<li><a href="'.ABS_LINK.$sigla.'/'.$liv_abreviado.'/'.$ver_capitulo.'#'.$db->f("id").'">'.$db->f("resposta").'...</a></li>';
         ...
         $comentarios_recentes .= '<div class="list-group-item">
                                            <div class="row-topic">
                                                <header class="topic-title clearfix">
                                                    <h3><a href="'.ABS_LINK.$sigla.'/'.$liv_abreviado.'/'.$ver_capitulo.'">'.$db->f("resposta").'...</a></h3>
                                                    <small>Em '.$liv_nome.'</small>
