		...
		for($i = 0; $i < $db->num_rows(); $i++)
		{
         $velho_testamento .= '<div class="list-group-item">
                                        <div class="row-content">
                                            <p class="list-group-item-heading"><a href="'.ABS_LINK.'asv/'.$db->f("liv_abreviado").'"><i class="material-icons">description</i> 
                                           '.$db->f("liv_nome").'</a></p>
                                        </div>
                                    </div>';
