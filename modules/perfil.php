               ...
               $listagem .= '<div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseEleven'.$i.'">'.$titulo.'</a>
                            </h4>
                        </div>
                        <div id="collapseEleven'.$i.'" class="panel-collapse collapse">
                            <div class="panel-body">
                            <p>Inscrito em '.$dataCadastro.'
                             <p><strong>Resumo do curso:</strong></p> '.$resumo.'
                            </div><a style="width:100%;" href="'.ABS_LINK.'cursos/curso/'.$slug.'" class="btn btn-raised btn-info gr">Ir para o curso</a>
                        </div>
                    </div><hr>';
         ...
         if(!isset($_SESSION['id']))
         {
            ...
            for($i = 0; $i < $db->num_rows(); $i++)
            {
               ...
               $listagem .= '<div class="panel panel-default">
                        ...
                        <div id="collapseEleven'.$i.'" class="panel-collapse collapse">
                            <div class="panel-body">
                            <p>Publicado em '.$dataCadastro.' | Situa&ccedil;&atilde;o: '.$situacao.' </p>
                            </div><a  href="'.ABS_LINK.'artigos/artigo/'.$slug.'" class="btn btn-raised btn-info gr">Ir para o artigo</a>  <a href="'.ABS_LINK.'perfil/edtArtigo/'.$artigo_id.'" class="btn btn-raised btn-info gr"><i class="material-icons">create</i> Editar</a> <a href="'.ABS_LINK.'perfil/delArtigo/'.$artigo_id.'" class="btn btn-raised btn-info gr"  onclick="return(confirm(\'Deseja excluir o artigo?\'))"><i class="material-icons">delete</i> Excluir</a>
                        </div>
                    </div><hr>';
         ...
         if(!isset($_SESSION['id']))
         {
            ...
            for($i = 0; $i < $db->num_rows(); $i++)
            {
               ...
               $listagem .= '<div class="panel panel-default">
                        ...
                        <div id="collapseEleven'.$i.'" class="panel-collapse collapse">
                            <div class="panel-body">
                            <p>Publicado em '.$dataCadastro.' | por: '.$usuario_nome.' | em '.$categoria.' </p>
                            </div><a  href="'.ABS_LINK.'artigos/artigo/'.$slug.'" class="btn btn-raised btn-info gr">Ir para o artigo</a>   <a href="'.ABS_LINK.'home/bookmarkArtigo/'.$artigo_id.'" class="btn btn-raised btn-info gr"  onclick="return(confirm(\'Deseja remover o artigo dos seus artigos salvos?\'))"><i class="material-icons">delete</i> Remover dos salvos</a>
                        </div>
                    </div><hr>';
      ...
      function insertArtigo()
      {
         ...
         $artigo_id = $db->get_last_insert_id("artigos","id");
				...
				if($_FILES['avatar']['name'] != "")
				{
					...
					// Caminho de onde a imagem ficará
					$imagem_dir = "files/artigos/".date("Y")."/".date("m")."/".$arquivo;

               if (!file_exists("files/artigos/".date("Y"))) {
                   mkdir("files/artigos/".date("Y"), 0777, true);
               }
               

               if (!file_exists("files/artigos/".date("Y")."/".date("m"))) {
                   mkdir("files/artigos/".date("Y")."/".date("m"), 0777, true);
               }
         ...
         if(!isset($_SESSION['id']))
         {
            ...
            for($i = 0; $i < $db->num_rows(); $i++)
            {
               ...
               $listagem .= '<div class="panel panel-default">
                        ...
                        <div id="collapseEleven'.$i.'" class="panel-collapse collapse">
                            <div class="panel-body">
                            <p>Publicado em '.$dataCadastro.' | em '.$categoria.' </p>
                            </div><a  href="'.ABS_LINK.'cursos/curso/'.$slug.'" class="btn btn-raised btn-info gr">Ir para o curso</a>   <a href="'.ABS_LINK.'home/bookmarkCurso/'.$curso_id.'" class="btn btn-raised btn-info gr"  onclick="return(confirm(\'Deseja remover o curso dos seus cursos salvos?\'))"><i class="material-icons">delete</i> Remover dos salvos</a>
                        </div>
                    </div><hr>';
