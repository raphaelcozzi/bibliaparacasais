...
$database = "bibliaon_base";
$dbdriver = "mysql"; 


/* Google App Client Id */
define('CLIENT_ID', '685101237513-ormfl98nh32jpenb5vpbbfc6k5du6fnd.apps.googleusercontent.com');

/* Google App Client Secret */
define('CLIENT_SECRET', 'LpV-q2ZiKktiyBbKDdC8ggfN');

/* Google App Redirect Url */
define('CLIENT_REDIRECT_URL', 'https://www.bibliaparacasais.com.br/gauth.php');
...
define("PORT_EMAIL","587"); // Porta de autenticação
