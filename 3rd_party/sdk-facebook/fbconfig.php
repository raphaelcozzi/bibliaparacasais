...
// login helper with redirect_uri
    $helper = new FacebookRedirectLoginHelper('https://www.bibliaparacasais.com.br/3rd_party/sdk-facebook/fbconfig.php' );
try {
...
if ( isset( $session ) ) {
 ...
 $request = new FacebookRequest( $session, 'GET', '/me?locale=pt_BR&fields=id,name,email' );
  ...
  header("Location: https://www.bibliaparacasais.com.br/index.php?module=login&method=facebookLogin");
} else {
